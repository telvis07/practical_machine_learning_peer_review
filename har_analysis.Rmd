...
Once we clean the data, we select the `r rf_important_varnames_length` columns corresponding to the variables found during feature selection and perform our predictions. See `Appendix 1` for code and predictions.
